  ...
  context 'when parse_header_checks_warning mask' do
    ...
    it do
      is_expected.to match_array [
        ["test.default", 1432492200, {"time"=>"Mar  4 14:44:19", "hostname"=>"P788", "process"=>"postfix/cleanup[7426]", "queue_id"=>"E80A9DF6F7E", "to"=>"********@yahoo.co.jp", "domain"=>"yahoo.co.jp", "from"=>"********@P788.local", "header_from"=>"local", "priority"=>"warning", "To"=>"********@yahoo.co.jp"}],
        ["test.default", 1432492200, {"time"=>"Mar  4 14:44:19", "hostname"=>"P788", "process"=>"postfix/cleanup[7426]", "queue_id"=>"E80A9DF6F7E", "to"=>"********@yahoo.co.jp", "domain"=>"yahoo.co.jp", "from"=>"********@P788.local", "header_from"=>"local", "priority"=>"warning", "Subject"=>"test"}],
      ]
    end
  end
end
